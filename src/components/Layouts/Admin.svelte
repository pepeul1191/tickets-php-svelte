<script>
  ...
  import Worker from '../Pages/Admin/Worker.svelte';
  import Service from '../Pages/Admin/Service.svelte';
  import ServiceType from '../Pages/Admin/ServiceType.svelte';
...
import ServiceDetail from '../Pages/Admin/ServiceDetail.svelte';
import WorkerDetail from '../Pages/Admin/WorkerDetail.svelte';
  export let url = '';
  export let basepath = '/';
  let modalComponent;
  let modalDOMStore;
...
<Router url="{url}" basepath="{basepath}">
  <div>
    ...
    <Route path="/worker/edit/:id" let:params><WorkerDetail id={params.id}/></Route>
    <Route path="/worker/add" component="{WorkerDetail}"></Route>
    <Route path="/position" component="{Position}" />
    <Route path="/service_type" component="{ServiceType}" />
    ...
    <Route path="/service/add" let:params><ServiceDetail id={'E'}/></Route>
    <Route path="/service/edit/:id" let:params><ServiceDetail id={params.id}/></Route>
