								...
								<tr>
									<td class="bg_white email-section" style="">
										<div class="heading-section heading-section-white">
											<p class="color_gray center">Muchas gracias por contactarnos.<br>%message</p>
											<p class="center"><a href="%base_url" class="btn btn-primary bg_primary">Ir al sitio web de %enterprise_name</a></p>
										</div>
									</td>
								</tr>
							</tbody>
